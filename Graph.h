...
#include "graph64.h"		// vertex, edgetype
...
public:
	...
	auto getIndextoName() noexcept // will be useful if need to match the index to name
	{
	...
	void addEdges(const std::vector<int> EDGES)
	{
