...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/nemolib.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/nemolib ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/NautyLink.o: NautyLink.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NautyLink.o NautyLink.cpp

${OBJECTDIR}/RandESU.o: RandESU.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandESU.o RandESU.cpp

${OBJECTDIR}/RandomGraphAnalysis.o: RandomGraphAnalysis.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomGraphAnalysis.o RandomGraphAnalysis.cpp

${OBJECTDIR}/RandomGraphGenerator.o: RandomGraphGenerator.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RandomGraphGenerator.o RandomGraphGenerator.cpp
